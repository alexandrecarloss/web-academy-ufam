...
const displayTotalItens = document.getElementById('displayTotalItens');
const displayCategorias = document.getElementById('displayCategorias');
function atualizarInterface() {
    if (!tabelaCorpo || !displayValorTotal || !displayTotalItens || !displayCategorias)
        return;
...
function adicionarProdutoDoFormulario() {
    ...
    switch (tipo) {
        case 'tv':
            ...
            const polegadas = document.getElementById('polegadas').value || 'N/A';
            novoProduto = new Tv(id, modelo, fabricante, preco, resolucao, polegadas);
            break;
        case 'celular':
            const memoria = document.getElementById('memoria').value || 'Não informada';
            novoProduto = new Celular(id, modelo, fabricante, preco, memoria);
            break;
        case 'bicicleta':
            const tamanhoAro = document.getElementById('tamanhoAro').value || 'N/A';
...
function limparFormulario() {
    ...
    document.getElementById('tamanhoAro').value = '';
}
if (btnAdicionar) {
